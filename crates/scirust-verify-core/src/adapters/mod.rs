...
pub use nnis_parity::{
    ingest_nnis_parity, NnisParityAdapterError, NnisParityIngest,
    NNIS_PARITY_EVIDENCE_MAX_BYTES, NNIS_PARITY_EVIDENCE_MEDIA_TYPE, NNIS_PARITY_RECORD_KIND,
    NNIS_PARITY_SOURCE_HEAD, NNIS_PARITY_SOURCE_MERGE, NNIS_PARITY_SUITE_KIND,
    NNIS_PARITY_VALIDATION_CONTRACT, NNIS_PARITY_VALIDATION_MAX_BYTES,
